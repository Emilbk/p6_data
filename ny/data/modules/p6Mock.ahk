...
class P6Mock  {
     ...
     */
    _KopierVærdi(pKlipGenvej, pHentMsgbox?, pNavigeringsSekvens?, pVentIkkePåClipboard?)
    {
        ...
        if (isset(pHentMsgbox) and pHentMsgbox != 0)
        {
            ...
            while a_clipboard = ""
            {
                ...
                else
                {
                    SendInput muligeKlipGenveje[pKlipGenvej]
                    sleep 100
                    this._tryClipWait clipwaitTidMsgbox
                    sleep 100
                }
            }
            return a_clipboard
            ...
            if IsSet(pVentIkkePåClipboard)
            {
                ...
                while a_clipboard = ""
                {
                    ...
                    else
                    {
                        ...
                        SendInput muligeKlipGenveje[pKlipGenvej]
                        sleep 100
                        this._tryClipWait clipwaitTidLoop
                        sleep 100
                    }
                }
                SendInput muligeKlipGenveje[pKlipGenvej]
    ...
    _enterOgHentMsgboxFejl() {
        SendInput("{Enter}")
        msgBoxFejl := this._KopierVærdi("ctrl", 1)
...
;             ;     msgbox := this._KopierVærdi("ctrl", 1)
...
;         mBoxtjek := this._KopierVærdi("ctrl", 1)
...
;         SendInput("!p")
;         planskema := this._KopierVærdi("ctrl", , , 1)
...
;         SendInput("!p{tab 4}")
;         Økonomiskema := this._KopierVærdi("ctrl", , , 1)
...
;         SendInput("!p{tab 6}")
;         Statistikgruppe := this._KopierVærdi("ctrl", , , 1)
...
;         SendInput("!p{tab 8}")
;         ParameterVognmand := this._KopierVærdi("ctrl", , , 1)
...
;         SendInput("!m+{tab 8}")
;         obligatoriskVognmand := this._KopierVærdi("ctrl", , , 1)
...
;         SendInput("!m+{tab 6}")
;         normalHjemzone := this._KopierVærdi("ctrl", , , 1)
...
;         loop 10
;         {
;             kørerIkkeTransportTyperOprRækkefølge.push(this._KopierVærdi("ctrl", , , 1))
;             SendInput("{tab}")
;         }
...
;         SendInput("!r")
;         pauseregel := this._KopierVærdi("ctrl", , , 1)
...
;         SendInput("!r{tab}")
;         pauseDynamisk := this._KopierVærdi("ctrl", , , 1)
...
;         SendInput("!r{tab 3}")
;         pauseStart := this._KopierVærdi("ctrl", , , 1)
...
;         SendInput("!r{tab 4}")
;         pauseSlut := this._KopierVærdi("ctrl", , , 1)
...
;         SendInput("!a")
;         vognmandNavn := this._KopierVærdi("ctrl", , , 1)
...
;         SendInput("!a{tab}")
;         vognmandCO := this._KopierVærdi("ctrl", , , 1)
...
;         SendInput("!a{tab 2}")
;         vognmandAdresse := this._KopierVærdi("ctrl", , , 1)
...
;         SendInput("!a{tab 3}")
;         vognmandPostNr := this._KopierVærdi("ctrl", , , 1)
...
;         SendInput("!a{tab 4}")
;         vognmandTelefon := this._KopierVærdi("ctrl", , , 1)
...
;         ; this._KopierVærdi("ctrl", 0, "!l{tab}")
;         this.navVindueVognløbvognløbsdato()
;         SendInput(vognløbsdatoTilIndlæsning)
;         SendInput("{enter}")
;         sleep 300

;         mBoxFejl := this._KopierVærdi("ctrl", 1)
;         this.tjekP6Msgbox(mBoxFejl)

;         ; TODO separat funk
;         tjekAfIndtastningVognløbsnummer := this._KopierVærdi("appsKey", 0, "!l")
;         tjekAfIndtastningVognløbsdato := this._KopierVærdi("ctrl", 0, "!l{tab}")
...
;         kørselsaftaleEksisterende := this._KopierVærdi("appsKey", 0, "!k")
;         styresystemEksisterende := this._KopierVærdi("appsKey", 0, "!k{tab}")
...
;         mBoxFejl := this._enterOgHentMsgboxFejl()
;         this.tjekP6Msgbox(mBoxFejl)
...
;         SendInput("{tab}")
;         SendInput("{enter}")
;         p6_msgbox := this._KopierVærdi("ctrl", 1)
...
;         statistikGruppe := this._KopierVærdi("ctrl")
...
;         {
;             startdato := this._KopierVærdi("ctrl")
...
;         {
;             startTid := this._KopierVærdi("ctrl")
...
;             normalSlutDato := this._KopierVærdi("Ctrl")
...
;             normalSluttid := this._KopierVærdi("Ctrl")
...
;             sidsteSlutDato := this._KopierVærdi("Ctrl")
...
;             sidsteSlutTid := this._KopierVærdi("Ctrl")
...
;         {
;             SendInput("!v+{Up}")
;             Vognløbsnotering := this._KopierVærdi("ctrl", , , 1)
...
;         {
;             SendInput("!ø{tab 2}")
;             chfKontaktNummer := this._KopierVærdi("appsKey")
...
;         {
;             SendInput("!ø{tab 3}")
;             Vognløbskategori := this._KopierVærdi("appsKey")
...
;         {
;             SendInput("!ø{tab 6}")
;             Planskema := this._KopierVærdi("appsKey")
...
;         {
;             SendInput("!ø{tab 8}")
;             Økonomiskema := this._KopierVærdi("appsKey")
...
;         {
;             SendInput("!ø{tab 9}")
;             Statistikgruppe := this._KopierVærdi("appsKey")
...
;             loop 19
;             {
;                 tType := this._KopierVærdi("ctrl", , , 1)
;                 if !tType
;                     break
